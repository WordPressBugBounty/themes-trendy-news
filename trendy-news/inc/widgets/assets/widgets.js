...
jQuery(document).ready( function($) {
    function trendy_news_widgets_handler() {
        // multicheckbox field
        $( ".trendy-news-multicheckbox-field" ).on( "click, change", ".multicheckbox-content input", function() {
            var _this = $(this), parent = _this.parents( ".trendy-news-multicheckbox-field" ), currentVal, currentFieldVal = parent.find( ".widefat" ).val();
        ...
        // checkbox field
        $( ".trendy-news-checkbox-field" ).on( "click, change", "input", function() {
            var _this = $(this)
            if( _this.is(":checked") ) {
                _this.val( "1" )
            } else {
        ...
        // upload field
        $( ".trendy-news-upload-field" ).on( "click", ".upload-trigger", function(event) {
        ...
        // remove image
        $( ".trendy-news-upload-field" ).on( "click", ".upload-buttons .remove-image", function(event) {
            event.preventDefault();
            var _this = $(this);
        ...
        // icon text handler
        var iconTextContainer = $( ".trendy-news-icon-text-field" )
