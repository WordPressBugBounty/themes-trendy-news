<?php
/**
 * Adds Trendy_News_Category_Collection_Widget widget.
 * 
 * @package Trendy News
 * @since 1.0.0
 */
class Trendy_News_Category_Collection_Widget extends WP_Widget {
    /**
     * Register widget with WordPress.
     */
    public function __construct() {
        parent::__construct(
            'trendy_news_category_collection_widget',
            esc_html__( 'TN : Category Collection', 'trendy-news' ),
            array( 'description' => __( 'A collection of post categories.', 'trendy-news' ) )
        );
    }
                                        ...
                                        <?php
                                            ...
                                            echo '<span class="category-count">';
                                                ...
                                                <span class="news_text">
                                                    <?php echo esc_html__( 'News', 'trendy-news' ); ?>
                                                </span>
                                                    <?php
                                            echo '</span>';
                                        ?>
    ...
    function widget_fields() {
        ...
        return array(
                array(
                    ...
                    'default'   => esc_html__( 'Category Collection', 'trendy-news' )
                ),
                array(
                    'name'      => 'posts_categories',
                    'type'      => 'multicheckbox',
                    'title'     => esc_html__( 'Post Categories', 'trendy-news' ),
                    'description'=> esc_html__( 'Choose the categories to display', 'trendy-news' ),
...
} // class Trendy_News_Category_Collection_Widget